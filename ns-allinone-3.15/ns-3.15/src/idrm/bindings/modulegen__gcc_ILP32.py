...
def module_init():
    root_module = Module('ns.idrm', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## idrm-helper.h (module 'idrm'): ns3::IdrmHelper [class]
    module.add_class('IdrmHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace idrm
    
    nested_module = module.add_cpp_namespace('idrm')
    register_types_ns3_idrm(nested_module)
...
def register_types_ns3_idrm(module):
    root_module = module.get_root()
    
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID'])
    ## idrm-packet.h (module 'idrm'): ns3::idrm::IdrmHeader [class]
    module.add_class('IdrmHeader', parent=root_module['ns3::Header'])
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::PacketQueue [class]
    module.add_class('PacketQueue')
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::QueueEntry [class]
    module.add_class('QueueEntry')
    ## idrm-routing-protocol.h (module 'idrm'): ns3::idrm::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTable [class]
    module.add_class('RoutingTable')
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    module.add_container('std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry >', ('ns3::Ipv4Address', 'ns3::idrm::RoutingTableEntry'), container_type='map')
...
def register_methods(root_module):
    ...
    register_Ns3IdrmHelper_methods(root_module, root_module['ns3::IdrmHelper'])
    ...
    register_Ns3IdrmIdrmHeader_methods(root_module, root_module['ns3::idrm::IdrmHeader'])
    register_Ns3IdrmPacketQueue_methods(root_module, root_module['ns3::idrm::PacketQueue'])
    register_Ns3IdrmQueueEntry_methods(root_module, root_module['ns3::idrm::QueueEntry'])
    register_Ns3IdrmRoutingProtocol_methods(root_module, root_module['ns3::idrm::RoutingProtocol'])
    register_Ns3IdrmRoutingTable_methods(root_module, root_module['ns3::idrm::RoutingTable'])
    register_Ns3IdrmRoutingTableEntry_methods(root_module, root_module['ns3::idrm::RoutingTableEntry'])
    return
...
def register_Ns3IdrmHelper_methods(root_module, cls):
    ## idrm-helper.h (module 'idrm'): ns3::IdrmHelper::IdrmHelper(ns3::IdrmHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IdrmHelper const &', 'arg0')])
    ## idrm-helper.h (module 'idrm'): ns3::IdrmHelper::IdrmHelper() [constructor]
    cls.add_constructor([])
    ## idrm-helper.h (module 'idrm'): ns3::IdrmHelper * ns3::IdrmHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::IdrmHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## idrm-helper.h (module 'idrm'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::IdrmHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## idrm-helper.h (module 'idrm'): void ns3::IdrmHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3IdrmIdrmHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## idrm-packet.h (module 'idrm'): ns3::idrm::IdrmHeader::IdrmHeader(ns3::idrm::IdrmHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::IdrmHeader const &', 'arg0')])
    ## idrm-packet.h (module 'idrm'): ns3::idrm::IdrmHeader::IdrmHeader(ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t hopcount=0, uint32_t dstSeqNo=0) [constructor]
    ...
    ## idrm-packet.h (module 'idrm'): uint32_t ns3::idrm::IdrmHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## idrm-packet.h (module 'idrm'): ns3::Ipv4Address ns3::idrm::IdrmHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## idrm-packet.h (module 'idrm'): uint32_t ns3::idrm::IdrmHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-packet.h (module 'idrm'): uint32_t ns3::idrm::IdrmHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-packet.h (module 'idrm'): ns3::TypeId ns3::idrm::IdrmHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## idrm-packet.h (module 'idrm'): uint32_t ns3::idrm::IdrmHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## idrm-packet.h (module 'idrm'): static ns3::TypeId ns3::idrm::IdrmHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## idrm-packet.h (module 'idrm'): void ns3::idrm::IdrmHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## idrm-packet.h (module 'idrm'): void ns3::idrm::IdrmHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## idrm-packet.h (module 'idrm'): void ns3::idrm::IdrmHeader::SetDst(ns3::Ipv4Address destination) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'destination')])
    ## idrm-packet.h (module 'idrm'): void ns3::idrm::IdrmHeader::SetDstSeqno(uint32_t sequenceNumber) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## idrm-packet.h (module 'idrm'): void ns3::idrm::IdrmHeader::SetHopCount(uint32_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    return

def register_Ns3IdrmPacketQueue_methods(root_module, cls):
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::PacketQueue::PacketQueue(ns3::idrm::PacketQueue const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::PacketQueue const &', 'arg0')])
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::PacketQueue::PacketQueue() [constructor]
    cls.add_constructor([])
    ## idrm-packet-queue.h (module 'idrm'): bool ns3::idrm::PacketQueue::Dequeue(ns3::Ipv4Address dst, ns3::idrm::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::idrm::QueueEntry &', 'entry')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::PacketQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## idrm-packet-queue.h (module 'idrm'): bool ns3::idrm::PacketQueue::Enqueue(ns3::idrm::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::idrm::QueueEntry &', 'entry')])
    ## idrm-packet-queue.h (module 'idrm'): bool ns3::idrm::PacketQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## idrm-packet-queue.h (module 'idrm'): uint32_t ns3::idrm::PacketQueue::GetCountForPacketsWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetCountForPacketsWithDst', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## idrm-packet-queue.h (module 'idrm'): uint32_t ns3::idrm::PacketQueue::GetMaxPacketsPerDst() const [member function]
    cls.add_method('GetMaxPacketsPerDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): uint32_t ns3::idrm::PacketQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): ns3::Time ns3::idrm::PacketQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): uint32_t ns3::idrm::PacketQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::PacketQueue::SetMaxPacketsPerDst(uint32_t len) [member function]
    cls.add_method('SetMaxPacketsPerDst', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::PacketQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::PacketQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3IdrmQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::QueueEntry::QueueEntry(ns3::idrm::QueueEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::QueueEntry const &', 'arg0')])
    ## idrm-packet-queue.h (module 'idrm'): ns3::idrm::QueueEntry::QueueEntry(ns3::Ptr<ns3::Packet const> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb=ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>(), ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb=ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>()) [constructor]
    ...
    ## idrm-packet-queue.h (module 'idrm'): ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::idrm::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): ns3::Time ns3::idrm::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): ns3::Ipv4Header ns3::idrm::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): ns3::Ptr<ns3::Packet const> ns3::idrm::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::idrm::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   ...
                   [], 
                   is_const=True)
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::QueueEntry::SetErrorCallback(ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    ...
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::QueueEntry::SetPacket(ns3::Ptr<ns3::Packet const> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## idrm-packet-queue.h (module 'idrm'): void ns3::idrm::QueueEntry::SetUnicastForwardCallback(ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb) [member function]
...
def register_Ns3IdrmRoutingProtocol_methods(root_module, cls):
    ## idrm-routing-protocol.h (module 'idrm'): ns3::idrm::RoutingProtocol::RoutingProtocol(ns3::idrm::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::RoutingProtocol const &', 'arg0')])
    ## idrm-routing-protocol.h (module 'idrm'): ns3::idrm::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## idrm-routing-protocol.h (module 'idrm'): int64_t ns3::idrm::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): bool ns3::idrm::RoutingProtocol::GetEnableBufferFlag() const [member function]
    cls.add_method('GetEnableBufferFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## idrm-routing-protocol.h (module 'idrm'): bool ns3::idrm::RoutingProtocol::GetEnableRAFlag() const [member function]
    cls.add_method('GetEnableRAFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## idrm-routing-protocol.h (module 'idrm'): static ns3::TypeId ns3::idrm::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## idrm-routing-protocol.h (module 'idrm'): bool ns3::idrm::RoutingProtocol::GetWSTFlag() const [member function]
    cls.add_method('GetWSTFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): bool ns3::idrm::RoutingProtocol::RouteInput(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): ns3::Ptr<ns3::Ipv4Route> ns3::idrm::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::SetEnableBufferFlag(bool f) [member function]
    cls.add_method('SetEnableBufferFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::SetEnableRAFlag(bool f) [member function]
    cls.add_method('SetEnableRAFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## idrm-routing-protocol.h (module 'idrm'): void ns3::idrm::RoutingProtocol::SetWSTFlag(bool f) [member function]
    cls.add_method('SetWSTFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## idrm-routing-protocol.h (module 'idrm'): ns3::idrm::RoutingProtocol::IDRM_PORT [variable]
    cls.add_static_attribute('IDRM_PORT', 'uint32_t const', is_const=True)
    return

def register_Ns3IdrmRoutingTable_methods(root_module, cls):
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTable::RoutingTable(ns3::idrm::RoutingTable const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::RoutingTable const &', 'arg0')])
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTable::RoutingTable() [constructor]
    cls.add_constructor([])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::AddIpv4Event(ns3::Ipv4Address address, ns3::EventId id) [member function]
    cls.add_method('AddIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address'), param('ns3::EventId', 'id')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::AddRoute(ns3::idrm::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::idrm::RoutingTableEntry &', 'r')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::AnyRunningEvent(ns3::Ipv4Address address) [member function]
    cls.add_method('AnyRunningEvent', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::DeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('DeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::ForceDeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('ForceDeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## idrm-rtable.h (module 'idrm'): ns3::EventId ns3::idrm::RoutingTable::GetEventId(ns3::Ipv4Address address) [member function]
    cls.add_method('GetEventId', 
                   'ns3::EventId', 
                   [param('ns3::Ipv4Address', 'address')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::GetListOfAllRoutes(std::map<ns3::Ipv4Address, ns3::idrm::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, ns3::idrm::RoutingTableEntry> > > & allRoutes) [member function]
    cls.add_method('GetListOfAllRoutes', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry > &', 'allRoutes')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nxtHp, std::map<ns3::Ipv4Address, ns3::idrm::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, ns3::idrm::RoutingTableEntry> > > & dstList) [member function]
    cls.add_method('GetListOfDestinationWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nxtHp'), param('std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry > &', 'dstList')])
    ## idrm-rtable.h (module 'idrm'): ns3::Time ns3::idrm::RoutingTable::Getholddowntime() const [member function]
    cls.add_method('Getholddowntime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::idrm::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::idrm::RoutingTableEntry &', 'rt')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::LookupRoute(ns3::Ipv4Address id, ns3::idrm::RoutingTableEntry & rt, bool forRouteInput) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::idrm::RoutingTableEntry &', 'rt'), param('bool', 'forRouteInput')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::Purge(std::map<ns3::Ipv4Address, ns3::idrm::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, ns3::idrm::RoutingTableEntry> > > & removedAddresses) [member function]
    cls.add_method('Purge', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry > &', 'removedAddresses')])
    ## idrm-rtable.h (module 'idrm'): uint32_t ns3::idrm::RoutingTable::RoutingTableSize() [member function]
    cls.add_method('RoutingTableSize', 
                   'uint32_t', 
                   [])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTable::Setholddowntime(ns3::Time t) [member function]
    cls.add_method('Setholddowntime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTable::Update(ns3::idrm::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::idrm::RoutingTableEntry &', 'rt')])
    return

def register_Ns3IdrmRoutingTableEntry_methods(root_module, cls):
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTableEntry::RoutingTableEntry(ns3::idrm::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::idrm::RoutingTableEntry const &', 'arg0')])
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), u_int32_t m_seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), u_int32_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now( ), ns3::Time SettlingTime=ns3::Simulator::Now( ), bool changedEntries=false) [constructor]
    ...
    ## idrm-rtable.h (module 'idrm'): ns3::Ipv4Address ns3::idrm::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): bool ns3::idrm::RoutingTableEntry::GetEntriesChanged() const [member function]
    cls.add_method('GetEntriesChanged', 
                   'bool', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::idrm::RouteFlags ns3::idrm::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::idrm::RouteFlags', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): uint32_t ns3::idrm::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Ipv4InterfaceAddress ns3::idrm::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Time ns3::idrm::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Ipv4Address ns3::idrm::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Ptr<ns3::NetDevice> ns3::idrm::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Ptr<ns3::Ipv4Route> ns3::idrm::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): uint32_t ns3::idrm::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): ns3::Time ns3::idrm::RoutingTableEntry::GetSettlingTime() const [member function]
    cls.add_method('GetSettlingTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetEntriesChanged(bool entriesChanged) [member function]
    cls.add_method('SetEntriesChanged', 
                   'void', 
                   [param('bool', 'entriesChanged')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetFlag(ns3::idrm::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::idrm::RouteFlags', 'flag')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetHop(uint32_t hopCount) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetLifeTime(ns3::Time lifeTime) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lifeTime')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> device) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'device')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetSeqNo(uint32_t sequenceNumber) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## idrm-rtable.h (module 'idrm'): void ns3::idrm::RoutingTableEntry::SetSettlingTime(ns3::Time settlingTime) [member function]
...
def register_functions(root_module):
    ...
    register_functions_ns3_idrm(module.get_submodule('idrm'), root_module)
    return

def register_functions_ns3_FatalImpl(module, root_module):
    return

def register_functions_ns3_idrm(module, root_module):
    return
