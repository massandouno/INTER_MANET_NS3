...
#ifndef IDRM_ROUTING_PROTOCOL_H
#define IDRM_ROUTING_PROTOCOL_H
...
public:
  static TypeId
  GetTypeId (void);
  static const uint32_t IDRM_PORT;
...
private:
  ...
  ///\name Receive idrm control packets
  // \{
  /// Receive and process idrm control packet
  void
  RecvIdrm (Ptr<Socket> socket);
  // \}
  void
