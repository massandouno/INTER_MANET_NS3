...
#include "ns3/idrm-packet.h"
#include "ns3/idrm-rtable.h"

namespace ns3 {
class IdrmHeaderTestCase : public TestCase
{
public:
  IdrmHeaderTestCase ();
  ~IdrmHeaderTestCase ();
...
IdrmHeaderTestCase::IdrmHeaderTestCase ()
  : TestCase ("Verifying the IDRM header")
{
}
IdrmHeaderTestCase::~IdrmHeaderTestCase ()
{
...
void
IdrmHeaderTestCase::DoRun ()
{
  Ptr<Packet> packet = Create<Packet> ();

  {
    idrm::IdrmHeader hdr1;
    hdr1.SetDst (Ipv4Address ("10.1.1.2"));
    hdr1.SetDstSeqno (2);
    hdr1.SetHopCount (2);
    packet->AddHeader (hdr1);
    idrm::IdrmHeader hdr2;
...
class IdrmTableTestCase : public TestCase
{
public:
  IdrmTableTestCase ();
  ~IdrmTableTestCase ();
...
IdrmTableTestCase::IdrmTableTestCase ()
  : TestCase ("Idrm Routing Table test case")
{
}
IdrmTableTestCase::~IdrmTableTestCase ()
{
...
void
IdrmTableTestCase::DoRun ()
{
  idrm::RoutingTable rtable;
  Ptr<NetDevice> dev;
  {
    idrm::RoutingTableEntry rEntry1 (
      /*device=*/ dev, /*dst=*/
    ...
    idrm::RoutingTableEntry rEntry2 (
      /*device=*/ dev, /*dst=*/
    ...
    idrm::RoutingTableEntry rEntry3 (
      /*device=*/ dev, /*dst=*/
    ...
    idrm::RoutingTableEntry rEntry4 (
      /*device=*/ dev, /*dst=*/
...
class IdrmTestSuite : public TestSuite
{
public:
  IdrmTestSuite () : TestSuite ("routing-idrm", UNIT)
  {
    AddTestCase (new IdrmHeaderTestCase ());
    AddTestCase (new IdrmTableTestCase ());
  }
} g_idrmTestSuite;
}
